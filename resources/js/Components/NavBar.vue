...
import NotificationFeature from './NotificationFeature.vue';
...
<template>
    ...
    <nav class="border-b border-slate-800 bg-slate-950/80 z-100 backdrop-blur-md text-gray-100 ">
            ...
            <div class="flex h-16 justify-between">
                ...
                <div class="hidden sm:ms-6 sm:flex sm:items-center">
                    ...
                    <div class="relative flex items-center ms-3">
                        <NotificationFeature v-if="$page.props.auth.user"/>
