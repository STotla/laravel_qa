...
<template>
    ...
    <header class="grid grid-cols-2    px-3 items-center gap-2 py-10 lg:grid-cols-3">
        ...
        <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end kishan">
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 mb-6 flex justify-between ">
            ...
            <div class="">
                ...
                <h1 class="text-4xl font-bold text-gray-900">Questions</h1>
                <p class="text-gray-600 mt-2">Browse and explore community questions</p>
            </div>
            <div>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6 border-b flex pb-4 last:border-b-0" v-for="question in questions.data"
                        ...
                        <div class="flex flex-col counters">
                            ...
                            <div :class="['answer status ', `${question.answer_status}`]">
                                <strong>{{ question.answers }}</strong>
                                {{ pluralize('answer', question.answers) }}
                            </div>
                        ...
                        <div>
                            <Link :href="route('questions.show', question.id)"
                                class="text-lg font-bold text-gray-900 mb-1 hover:text-blue-600 block">
                                {{ question.title }}
                            </Link>
                            <div class="flex items-center justify-between mb-2 text-sm text-gray-500">
                                <span class="font-medium text-gray-600">Asked By: {{ question.user.name }}</span>
                                <span>{{ question.created_date }}</span>
                            </div>
                            <p class="text-gray-700 mb-3">{{ question.body }}</p>
                        </div>
